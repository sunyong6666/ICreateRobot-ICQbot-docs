...
| 3.  Start using the fan:  <br/>  First, wake up ICQbot by saying "Hello, Xiao Q."<br/>  Use voice commands like “Motor one forward/backward” to control the fan's rotation.<br/> Say “Stop motion” to stop the motor. | |
